...
for file = test_files'
    ...
    % Run associator
    rec_dict_tseries = zeros(num_receivers, length(file.name));
    rec_dict_tseries(1, :) = file.name;
    ...
    save_data_format(corr_times, noise_intervals.t, rec_dict_tseries, ...
        wav_dir, programs_dir, t_bounds, pass_band, stop_band, filter_order, gamma, ...
        v1, v2, noise_thresh, max_noise_dur, min_noise_dur, sig_intervals, freq_intervals);
end
